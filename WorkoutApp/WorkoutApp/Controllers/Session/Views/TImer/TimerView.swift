...
//  WorkoutApp
//
//  Created by Всеволод Буртик on 16.08.2024.
//
...
final class TimerView: WABaseInfoView {
    ...
    func configure(with duration: Double, progress: Double) {
        ...
        let goalValurDevider = duration == 0 ? 1 : duration
        let percent: CGFloat = tempCurrentValue / goalValurDevider
